...
namespace Lykke.Job.HistoryExportBuilder
{
    ...
    public class Startup
    {
        ...
        {
            ApiTitle = "HistoryExportBuilder API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "HistoryExportBuilderLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.HistoryExportBuilderJob.Db.LogsConnString;
